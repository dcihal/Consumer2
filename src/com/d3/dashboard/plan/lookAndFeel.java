	...
	/*	@BeforeClass
		...
		{	
		  ...
		  public void verifyQuickPayCurrentDate(String userName, String passWord, String secretQuestion) 
		  {
			   ...
			   Utils.isTextPresent(driver, "Net Worth");
			   Utils.isTextPresent(driver, "Budget Summary");
			   Utils.isTextPresent(driver, "Cash Summary");
			   Utils.isTextPresent(driver, "Cash Flow Trends");
			   Utils.isTextPresent(driver, "Financial Goal Progress");
			   Utils.isTextPresent(driver, "Spending Summary");
		  } 
