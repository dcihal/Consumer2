...
import com.gurock.testrail.APIException;
	...
	public class downloadCsvAll {
		...
		{	
		  ...
		  @Test(priority = 38, groups = {"smoke", "regression"})
		  @Parameters({"userName", "passWord", "secretQuestion"})
		  public void verifyDownloadCsvAll(String userName, String passWord, String secretQuestion) 
		  {
			   TestCase = "38";
