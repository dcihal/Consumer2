...
import com.gurock.testrail.APIException;
	...
	public class changeCategoryIgnore {
		...
		{	
		  ...
		  @Test(priority = 34, groups = {"smoke", "regression"})
		  @Parameters({"userName", "passWord", "secretQuestion"})
		  public void verifyChangeCategoryIgnore(String userName, String passWord, String secretQuestion) 
		  {
			   TestCase = "34";
