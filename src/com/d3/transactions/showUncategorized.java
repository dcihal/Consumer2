...
import com.gurock.testrail.APIException;
	...
	public class showUncategorized {
		...
		{	
		  ...
		  @Test(priority = 29, groups = {"smoke", "regression"})
		  @Parameters({"userName", "passWord", "secretQuestion"})
		  public void verifyShowUncategorized(String userName, String passWord, String secretQuestion) 
		  {
			   TestCase = "29";
