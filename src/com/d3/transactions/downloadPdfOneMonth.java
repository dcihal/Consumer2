...
import com.gurock.testrail.APIException;
	...
	public class downloadPdfOneMonth {
		...
		{	
		  ...
		  @Test(priority = 39, groups = {"smoke", "regression"})
		  @Parameters({"userName", "passWord", "secretQuestion"})
		  public void verifyDownloadPdfOneMonth(String userName, String passWord, String secretQuestion) 
		  {
			   TestCase = "39";
